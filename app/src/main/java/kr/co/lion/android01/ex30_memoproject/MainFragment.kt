...
import kr.co.lion.android01.ex30_memoproject.databinding.FragmentMainBinding
...
class MainFragment : Fragment() {
    ...
    fun replaceFragment(name:FragmentName2, addToBackStack:Boolean, isAnimate:Boolean, data:Bundle?){
        ...
        if(newFragment != null){
            ...
            fragmentTransaction.replace(R.id.mainContainer2, newFragment!!)
